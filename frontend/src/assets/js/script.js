...
(function ($) {
  ...
  $('.testimonials-section .testimonial-heading  ').css(
    'left',
  ...
  $('.media-section .featured-img1 .image-upload').change(function () {
    ...
    for (var i = 0; i < $(this)[0].files.length; i++) {
      $('.media-section .featured-img1 .media-image').append(
        '<img src="' + window.URL.createObjectURL(this.files[i]) + '">'
      );
    }
  });
  ...
  $('.media-section .featured-img2 .image-upload').change(function () {
    ...
    for (var i = 0; i < $(this)[0].files.length; i++) {
      $('.media-section .featured-img2 .media-image').append(
        '<img src="' + window.URL.createObjectURL(this.files[i]) + '">'
      );
    }
  });
  ...
  if ($('#listdata-table').length > 0) {
    $('#listdata-table').dataTable({
      autoWidth: false,
      columns: [{ width: '135' }, null, null, null, null],
      searching: false,
      paging: false,
      info: false,
    });
