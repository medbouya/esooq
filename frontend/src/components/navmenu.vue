<template>
  <ul class="main-nav">
    <li
      ...
      :class="IndexMenu ? 'active' : 'notactive'"
    >
    ...
    <li class="has-submenu" :class="ListingsMenu ? 'active' : 'notactive'">
      <a href="javascript:void()"
        >Listings <i class="fas fa-chevron-down"></i
      ></a>
      <ul class="submenu">
        <li :class="currentPath == 'listing-grid' ? 'active' : 'notactive'">
          <router-link to="listing-grid">Listing Grid</router-link>
        </li>
        <li
          :class="
            currentPath == 'listing-grid-sidebar' ? 'active' : 'notactive'
          "
        >
          <router-link to="listing-grid-sidebar"
            >Listing Grid Sidebar</router-link
          >
        </li>
        <li
          :class="
            currentPath == 'listing-list-sidebar' ? 'active' : 'notactive'
          "
        >
          <router-link to="listing-list-sidebar"
            >Listing List Sidebar</router-link
          >
        </li>
        <li :class="currentPath == 'listingmap-list' ? 'active' : 'notactive'">
          <router-link to="listingmap-list">Listing List Map</router-link>
        </li>
        <li :class="currentPath == 'listingmap-grid' ? 'active' : 'notactive'">
          <router-link to="listingmap-grid">Listing Grid Map</router-link>
        </li>
      </ul>
    </li>
    <li class="has-submenu" :class="PagesMenu ? 'active' : 'notactive'">
      ...
      <ul class="submenu">
        <li :class="currentPath == 'about' ? 'active' : 'notactive'">
    ...
    <li class="has-submenu" :class="UserMenu ? 'active' : 'notactive'">
      <a href="javascript:void()"
        >User Pages <i class="fas fa-chevron-down"></i
      ></a>
      <ul class="submenu">
        <li :class="currentPath == 'dashboard' ? 'active' : 'notactive'">
          <router-link to="/dashboard">Dashboard</router-link>
        </li>
        <li :class="currentPath == 'profile' ? 'active' : 'notactive'">
          <router-link to="/profile">Profile</router-link>
        </li>
        <li :class="currentPath == 'my-listing' ? 'active' : 'notactive'">
          <router-link to="/my-listing">My Listing</router-link>
        </li>
        <li :class="currentPath == 'bookmarks' ? 'active' : 'notactive'">
        ...
        <li :class="currentPath == 'add-listing' ? 'active' : 'notactive'">
    ...
    <li class="has-submenu" :class="BlogMenu ? 'active' : 'notactive'">
      ...
      <ul class="submenu">
        ...
        <li
          :class="currentPath == 'blog-list-sidebar' ? 'active' : 'notactive'"
        >
          <router-link to="/blog-list-sidebar">Blog List Sidebar</router-link>
        </li>
        <li
          :class="currentPath == 'blog-grid-sidebar' ? 'active' : 'notactive'"
        >
          <router-link to="/blog-grid-sidebar">Blog Grid Sidebar</router-link>
        </li>
      </ul>
    </li>
...
export default {
  ...
  computed: {
    ...
    ListingsMenu() {
      return (
        this.$route.name == 'listing-grid' ||
        this.$route.name == 'listing-grid-sidebar' ||
        this.$route.name == 'listing-list-sidebar' ||
        this.$route.name == 'listingmap-list' ||
        this.$route.name == 'listingmap-grid'
      );
    },
    PagesMenu() {
      return (
    ...
    BlogMenu() {
      return (
        ...
        this.$route.name == 'blog-list-sidebar' ||
        this.$route.name == 'blog-grid-sidebar'
      );
    },
  },
};
