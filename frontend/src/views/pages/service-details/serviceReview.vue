          ...
          <li class="review-box">
            ...
            <div class="review-details">
              ...
              <div class="rating">
                ...
                <div>
                  <i class="fa-sharp fa-solid fa-calendar-days"></i> 4 months
                  ago
                </div>
                ...
                >
                  <div class="review-gallery">
                    <img
                      class="img-fluid"
                      alt="Image"
                      :src="require(`../../../assets/img/gallery/${src.src}`)"
                    />
                  </div>
                </div>
                <vue-easy-lightbox
              ...
              <div class="reply-box">
                <p>
                  Was This Review...?
                  <a href="#" class="thumbsup"
                    ><i class="feather-thumbs-up"></i> Like
                  </a>
                  <a href="#" class="thumbsdown"
                    ><i class="feather-thumbs-down"></i> Dislike
                  </a>
                </p>
