      ...
      <div class="row">
        <div class="col-md-12 aos" data-aos="fade-up">
          <div class="section-heading-two white-text text-center">
            ...
            <img
              src="../../../assets/img/title-img-white.png"
              class="img-fluid"
              alt="title-img"
            />
          </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 col-md-6 d-flex aos" data-aos="fade-up">
          <div class="package-wrap flex-fill">
            ...
            <div class="couple-img">
              <img
                src="../../../assets/img/bg/couple-01.png"
                class="img-fluid"
                alt="title-img"
              />
            </div>
        ...
        <div class="col-lg-4 col-md-6 d-flex aos" data-aos="fade-up">
          <div class="package-wrap flex-fill">
            ...
            <div class="couple-img">
              <img
                src="../../../assets/img/bg/couple-02.png"
                class="img-fluid"
                alt="title-img"
              />
            </div>
        ...
        <div class="col-lg-4 col-md-6 d-flex aos" data-aos="fade-up">
          <div class="package-wrap flex-fill">
            ...
            <div class="couple-img">
              <img
                src="../../../assets/img/bg/couple-03.png"
                class="img-fluid"
                alt="title-img"
              />
            </div>
              ...
              <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 aos" data-aos="fade-up">
                  <div class="success-item">
                    <img
                      src="../../../assets/img/icons/wed-icon-01.svg"
                      class="img-fluid"
                      alt="title-img"
                    />
                ...
                <div class="col-lg-4 col-md-6 aos" data-aos="fade-up">
                  <div class="success-item">
                    <img
                      src="../../../assets/img/icons/wed-icon-02.svg"
                      class="img-fluid"
                      alt="title-img"
                    />
                ...
                <div class="col-lg-4 col-md-6 aos" data-aos="fade-up">
                  <div class="success-item">
                    <img
                      src="../../../assets/img/icons/wed-icon-03.svg"
                      class="img-fluid"
                      alt="title-img"
                    />
