      ...
      <div class="row">
        <div class="col-sm-12">
                    ...
                    <div class="col-auto col-md-3">
                      <div class="col-style">
                        ...
                        <ul>
                          ...
                          <li>
                            <router-link to="/service-details"
                              >Activity Finder</router-link
                            >
                          </li>
                          <li>
                            <router-link to="/service-details"
                              >Flight finder</router-link
                            >
                          </li>
                          <li>
                            <router-link to="/service-details"
                              >Holiday Rental</router-link
                            >
                          </li>
                          <li>
                            <router-link to="/service-details"
          ...
          <div class="btm-foo-widget">
            <div class="copy-info">
              <p class="mb-0">
                Copyright © {{ new Date().getFullYear() }} Listee. All rights
                are reserved
              </p>
            </div>
            <div class="payment-info">
              <ul class="d-flex">
                <li>
                  <img
                    class="img-fluid"
                    src="../../../assets/img/icons/visa-01.svg"
                    alt="visa"
                  />
                </li>
                <li>
                  <img
                    class="img-fluid"
                    src="../../../assets/img/icons/master-01.svg"
                    alt="paycard"
                  />
                </li>
                <li>
