    ...
    <div class="container">
      ...
      <div class="share-postsection">
        <div class="row">
          <div class="col-lg-4">
            <div class="sharelink">
              <a href="javasvript:void();" class="share-img"
      ...
      <div class="blogdetails-pagination">
        <ul>
          <li>
            <router-link to="/blog-details" class="prev-link"
              ><i class="fas fa-regular fa-arrow-left"></i> Previous
              Post</router-link
            >
          ...
          <li>
            <router-link to="/blog-details" class="next-link"
