                    ...
                    <div class="blog-widget">
                      <div class="blog-img">
                        <router-link to="service-details">
                          <img
                            :src="
                              require(`../../../../assets/img/list/${item.image}`)
                            "
                            class="img-fluid"
                            alt="blog-img"
                          />
                        ...
                        <div class="card-body">
                          <div class="blogfeaturelink">
                            <div class="grid-author">
                              <img
                                :src="
                                  require(`../../../../assets/img/profiles/${item.author}`)
                                "
                                alt="author"
                              />
                            </div>
                          ...
                          <div class="amount-details">
                            ...
                            <div class="ratings"><span>4.7</span> (50)</div>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          >
            <b-button variant="btn filterbtn">
              <span class="showfilter-btn"
                ...
                Show Filters</span
              >
              <span class="hidefilter-btn"
                ><i class="feather-eye-off"></i> Hide Filters</span
              >
            </b-button>
