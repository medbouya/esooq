            ...
            <div class="card">
              ...
              <b-form>
                ...
                <div class="filter-content form-group">
                  <vue-select :options="Works" placeholder="Choose Category" />
                </div>
                <div
                  class="filter-content looking-input form-group input-placeholder"
                >
                  <div class="group-img">
                    <b-form-input
                      type="text"
                ...
                <div class="filter-content form-group region">
                  <vue-select :options="Region" placeholder="Region" />
                </div>
                ...
                <div class="filter-content amenities mb-0">
                  ...
                  <div class="search-btn">
                    <b-button variant="primary" type="submit">
                      ...
                      Search</b-button
                    >
                    <b-button variant="reset mb-0" type="submit">
                      <i class="fas fa-light fa-arrow-rotate-right"></i> Reset
                      Filters</b-button
                    >
                  </div>
                </div>
          ...
          <div class="grid-view listgrid-sidebar">
            <div class="row">
              <div
                ...
                v-for="item in ListingGridSidebar"
                :key="item.id"
              >
                <div class="card">
                  <div class="blog-widget">
                    <div class="blog-img">
                      <router-link to="service-details">
                        <img
                          :src="
                            require(`../../../../assets/img/list/${item.img1}`)
                          "
                          class="img-fluid"
                          alt="blog-img"
                        />
                      ...
                      <div class="card-body">
                        <div class="blogfeaturelink">
                          <div class="grid-author">
                            <img
                              :src="
                                require(`../../../../assets/img/profiles/${item.img2}`)
                              "
                              alt="author"
                            />
                          </div>
              ...
              <ul class="pagination">
                <li class="page-item previtem">
                  <a class="page-link" href="#"
                    ><i class="fas fa-regular fa-arrow-left"></i> Prev</a
                  >
                </li>
...
.roundskin-slider .slider-horizontal .slider-handle {
  top: calc(
    (var(--slider-handle-height, 30px) - var(--slider-height, 12px)) / 2 * -1 +
      2px
  );
  width: 24px;
  height: 24px;
