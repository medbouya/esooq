        ...
        <div class="faq-card">
          <h4 class="faq-title">
            <router-link
              ...
              to="#faqOne"
              aria-expanded="false"
              >Why won’t my payment go through?</router-link
            >
          </h4>
          <div id="faqOne" class="card-collapse collapse">
            ...
            <p class="border border-0">
              ...
              sollicitudin quam sagittis nec.
            </p>
          </div>
        </div>
        <div class="faq-card">
          <h4 class="faq-title">
            <router-link
              ...
              to="#faqTwo"
              aria-expanded="false"
              >How to I get a refund?</router-link
            >
          </h4>
        ...
        <div class="faq-card">
          <h4 class="faq-title">
            <router-link
              ...
              to="#faqThree"
              aria-expanded="false"
              >How do I redeem a coupon?</router-link
            >
          </h4>
        ...
        <div class="faq-card mb-0">
          <h4 class="faq-title">
            <router-link
              ...
              to="#faqFour"
              aria-expanded="false"
              >How do I change Account Profile Name</router-link
            >
          </h4>
