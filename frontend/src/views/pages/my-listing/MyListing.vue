        ...
        <div class="dash-cards card">
          <div class="card-header">
            ...
            <router-link
              ...
              to="/add-listing"
              ><i class="fa-solid fa-plus"></i> Add Listing</router-link
            >
          </div>
          <div class="card-body">
                    ...
                    <div class="listingtable-img">
                      <router-link to="/service-details">
                        <img
                          ...
                          :src="
                            require(`../../../assets/img/list/${record.image}`)
                          "
                          alt=""
                        />
                      </router-link>
                  ...
                  <template v-else-if="column.key === 'id'">
                    ...
                    <div class="listingtable-rate">
                      <a href="javascript:void(0)" class="cat-icon"
                        ><i class="fa-regular fa-circle-stop"></i> Electronics
                      </a>
                      <span class="discount-amt">$350000.00</span
                      ><span class="fixed-amt">$40000</span>
                    </div>
